...
# local_config=local_configs.MyEdges.DFormer_Base_3cls_weighted   # or DFormerv2_...
# checkpoint=checkpoints/MyEdges/DFormer_Base_3cls_weighted/latest.pth  # or best_mIoU.pth
# img_dir=datasets/MyEdges/RGB
# depth_dir=datasets/MyEdges/Depth
# save_dir=outputs/MyEdges/pred_png
